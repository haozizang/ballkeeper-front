<template>
  <tm-app>
    <tm-sheet :margin="[0, 0]" :padding="[0, 0]" :transprent="true">
      ...
      <dx-team :category-list="categoryList" v-else-if="act_ind === 2"></dx-team>
      <dx-member v-else-if="act_ind === 3"></dx-member>
    </tm-sheet>
    ...
    <tm-tabbar :autoSelect="false" v-model:active="act_ind" :showSafe="false" @change="tabbarChange">
      ...
      <!-- <tm-tabbar-item :shadow="2" btn-top fontColor="white" activeColor="white" linear="top" linearDeep="accent" color="#38cdde" icon="tmicon-paperplane-fill" url="/others/publish/publish" text="发起" ></tm-tabbar-item> -->
      <tm-tabbar-item @click="act_ind = 2" activeColor="#3c8af8" text="待定" icon="tmicon-layergroup-fill"></tm-tabbar-item>
      <tm-tabbar-item @click="act_ind = 3" activeColor="#3c8af8" text="我的" icon="tmicon-md-person"></tm-tabbar-item>
    </tm-tabbar>
  </tm-app>
</template>
